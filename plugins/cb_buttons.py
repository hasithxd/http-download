...
from plugins.download_http_button import youtube_dl_call_back
...
async def button(bot, update):
    ...
    if ":" in cb_data:
        ...
        if index_extractor == "NONE":
            ...
            await bot.edit_message_text(
                chat_id=update.message.chat.id,
                text=Style.ZIP_UPLOADED_STR.format(i, "0"),
                message_id=update.message.id
            )
        else:
            ...
            await bot.edit_message_text(
                chat_id=update.message.chat.id,
                text=Style.ZIP_UPLOADED_STR.format("1", "0"),
                message_id=update.message.id
            )
    elif "|" in cb_data:
